    ...
    <>
      <section>
        <div className="flex justify-evenly items-center gap-5 pt-16">
          <div className="flex flex-col items-start w-96 border rounded-2xl p-5 space-y-3">
            <WalletMinimalIcon className="text-zinc-400" />
            <h4 className="text-base font-semibold text-zinc-600">
              Total Income{" "}
            </h4>
            <h2 className="text-3xl dark:text-zinc-50 dark:bg-black font-bold bg-zinc-50 text-zinc-800"> $250,000.00</h2>
          </div>
          <div className="flex flex-col items-start w-96 border rounded-2xl p-5 space-y-3">
            ...
            <h2 className="text-3xl dark:text-zinc-50 dark:bg-black font-bold bg-zinc-50 text-zinc-800">36.2%</h2>
          </div>
          <div className="flex flex-col items-start w-96 border rounded-2xl p-5 space-y-3">
            ...
            <h2 className="text-3xl dark:text-zinc-50 dark:bg-black font-bold bg-zinc-50 text-zinc-800"> 36</h2>
          </div>
          <div className="flex flex-col items-start w-96 border rounded-2xl p-5 space-y-3">
            ...
            <h2 className="text-3xl dark:text-zinc-50 dark:bg-black font-bold bg-zinc-50 text-zinc-800"> 29</h2>
          </div>
        </div>
      </section>
    </>
